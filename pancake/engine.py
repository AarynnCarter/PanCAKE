...
def calculate_reference(raw_config):
	"""
	Deprecated - Run a pandeia coronagraphy calculation in target-only mode, replacing the target scene with
...
def calculate_contrast(raw_config, offset_x=0.5, offset_y=0.5):
	"""
	Deprecated - Run a pandeia coronagraphy calculation in target-only mode, with the target offset to be
